...
class Barang_Hasil extends Component{
    render(){
        return(
        <div className="section">
            <div className="wrapper">
                <div className="shop-header">
                    <h3 className="no-margin w-hidden-small w-hidden-tiny">All Toys</h3>
                    <div className="shop-categories-wrapper"><a href="/catalog" className="shop-category-link w--current">All Toys</a>
                        <div className="w-dyn-list">
                            <div className="shop-categories w-dyn-items">
                                <div className="w-dyn-item"><a href="/category/wooden-toys" className="shop-category-link">Wooden Toys</a></div>
                                <div className="w-dyn-item"><a href="/category/stuffed-animals" className="shop-category-link">Stuffed Animals</a></div>
                            </div>
                        </div>
                    </div>
